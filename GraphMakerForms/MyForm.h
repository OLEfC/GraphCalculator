...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label15->Text = L"Введіть функцію:";
			// 
			// graph2_ColorD
			// 
			...
			this->зберегтиToolStripMenuItem->Size = System::Drawing::Size(215, 26);
			...
			this->експортуватиPngToolStripMenuItem->Size = System::Drawing::Size(215, 26);
			this->експортуватиPngToolStripMenuItem->Text = L"Експортувати png";
